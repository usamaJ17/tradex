...
class CreateConditionSellsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('condition_sells', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('user_id')->unsigned();
            $table->bigInteger('condition_buy_id')->unsigned();
    ...
    {
        Schema::dropIfExists('condition_sells');
    }
}
