...
class SellOrderHistory implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        try{
            $data = Sell::select(DB::raw("users.email as email, base_coin_table.coin_type as base_coin, trade_coin_table.coin_type as trade_coin, price,
