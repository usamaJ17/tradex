...
class FutureTradeCloseOrderRequest extends FormRequest
{
    /**
    ...
    {
        $rules = [
            'side'=>'required|in:'.TRADE_TYPE_BUY.','.TRADE_TYPE_SELL,
            ...
            'leverage_amount'=>'required|integer',
        ];
    ...
    {
        $messages = [
            'side.required' => __('Side is required!'),
            'side.in' => __('Invalid Input for Side!'),
            ...
            'leverage_amount.integer' => __('Leverage amount must be integer!'),
        ];
