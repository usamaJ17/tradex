                                ...
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    <a href="{{ settings('exchange_url') }}">
                                        <img class="w-24" 
                                        style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 96px; border-style: none; border-width: 0;" width="96" alt="Tenable Network Security"
