                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <div class="cp-select-area">
                                        <select name="kyc_withdrawal_setting_status" id="" class="form-control" title="{{ __('select option') }}" data-live-search="true" data-width="100%" data-style="btn-info" data-actions-box="true" data-selected-text-format="count > 4">
